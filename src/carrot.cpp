...
double x[]={6.025,9.9, 11.125, 11.175, 11.925, 15.525, 8.175, -5.625, -14.4, -12.975, -1.2, -1.589, -12.875, -13.326, -9.8}, y[]={0.5, 0.2, -1.275, -8.65, -10.875, -14.987, -20.35, -19.825, -14.675, -12.675, -13, -11.091, -11.3, -1.903, 0};
double delta = 1;
...
void callback(const nav_msgs::OdometryConstPtr &od){
	...
	if(sqrt(pow((x[ra]-od->pose.pose.position.x),2) + pow((y[ra] - od->pose.pose.position.y),2))<1) i = ra;
